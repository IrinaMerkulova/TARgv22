...
--- foreign key lisamine tabelisse Person
alter table Person add constraint tblPerson_GenderId_FK
foreign key (GenderId) references Gender(Id)

-- sisestatud andmed Person tabelisse
...
--kontrolliti kas kehtib Person_Age check
select * from Person
go
...
--lisame vanust inimestele
UPDATE Person set Age='25'
UPDATE Person set Age='44' Where Id=3 or Id=6;
...
--name does not start with the letters "W", "A", or "S".
select * from Person where Name like '[^WAS]%'
---  kõik  "Person" tabelist kus  "City" column on kas "Gotham" or "New York" ja "Age"  suurem or equal to 40.
...
--Lisame tabelisse Department andmed Id, DepartmentName, Location, DepartmentHead
