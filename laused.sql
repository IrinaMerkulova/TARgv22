...
--- tabeli muutmine piirangi lisamine - foreign key
...
--- näitab, kelle vanus on rohkem või on 40 ja kes elab Gothamis või New Yorkis
...
--iga linna kohta vanuse summeerimine
...
--Department tabelisse andmete lisamine
...
--paneb uue city row tabelisse Employees
alter table Employees
add City nvarchar(25)

--ei saa käivitada DepartmentId juba olemas
alter table Employees
add DepartmentId
int null


--paneb uue MiddleName ja LastName row tabelisse Employees
alter table Employees
add MiddleName nvarchar(30)

alter table Employees
add LastName nvarchar(30)
--Uuendab andmeid tabelis Employees/ siin oli pannud FirstName aga on vaja panna lihtsalt Name
