...
--tabeli muutmine piirangu lisamine - на столбец Age таблицы Person.
alter table Person
...
--удаление записи из таблицы Person, где значение в столбце Id равно 8 + разделение запросов функцией GO
select * from Person
go
...
--- näitab nimed, kus linn Gotham või New York ja vanus rohkem või võrra 40
...
--sisestame andmed tabelisse department ja employees
